    ...
    */
    ...
    describe('The menu', function() {
        ...
        /* TODO: Write a test that ensures the menu changes
          ...
          */
        it('menu show when the menu icon is clicked', function() {
            menuBody.classList.toggle('menu-hidden');
            expect(menuBody.classList.contains('menu-hidden')).toBe(false);
        });

        it('menu hides when the menu icon is clicked again', function() {
            menuBody.classList.toggle('menu-hidden');
            expect(menuBody.classList.contains('menu-hidden')).toBe(true);
        });
    });
    ...
    describe('Initial Entries', function() {
        ...
        it('loadFeed function is called and completes its work, there is at least a single .entry element within the .feed container', function(done) {
    ...
    describe('New Feed Selection', function() {
        ...
        beforeEach(function (done) {
            loadFeed(0, function () {
                initial = document.querySelector('.feed').textContent;
                loadFeed(1, done);
            });
        });
        ...
        it('a new feed is loaded by the loadFeed function that the content actually changes', function(done) {
            ...
            expect(initial).not.toEqual(newFeed);
            done();
        });
    });
}());
